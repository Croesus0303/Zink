...
class AppColors {
  ...
  static RadialGradient get radialBackgroundGradient => RadialGradient(
        ...
        radius: 1.8,
        colors: [
          primaryCyan.withValues(alpha: 0.06),
          Colors.transparent,
  ...
  static LinearGradient get auroraGlassGradient => LinearGradient(
        ...
        colors: [
          ...
          rosyBrown.withValues(alpha: 0.08),
          pineGreen.withValues(alpha: 0.06),
          midnightGreen.withValues(alpha: 0.04),
        ],
  ...
  static LinearGradient get iceGlassGradient => LinearGradient(
        ...
        colors: [
          ...
          rosyBrown.withValues(alpha: 0.10),
          pineGreen.withValues(alpha: 0.08),
  ...
  static LinearGradient get auroraBackgroundGradient => LinearGradient(
        ...
        colors: [
          midnightGreenDark,
          midnightGreen,
          pineGreenDark.withValues(alpha: 0.8),
          midnightGreen,
        ],
        stops: const [0.0, 0.3, 0.7, 1.0],
      );
  ...
  static RadialGradient get auroraRadialGradient => RadialGradient(
        ...
        radius: 1.5,
        colors: [
          rosyBrown.withValues(alpha: 0.3),
          pineGreen.withValues(alpha: 0.2),
          Colors.transparent,
          midnightGreen.withValues(alpha: 0.1),
        ],
        stops: const [0.0, 0.3, 0.6, 1.0],
      );

  // Utility colors
  static Color get cyanWithOpacity => primaryCyan.withValues(alpha: 0.15);
  static Color get orangeWithOpacity => primaryOrange.withValues(alpha: 0.15);
  static Color get beigeWithOpacity => warmBeige.withValues(alpha: 0.15);
  static Color get rosyBrownWithOpacity => rosyBrown.withValues(alpha: 0.15);
  static Color get pineGreenWithOpacity => pineGreen.withValues(alpha: 0.15);

  // Border colors for glass effect
  static Color get glassBorder => Colors.white.withValues(alpha: 0.2);
  static Color get cyanBorder => primaryCyan.withValues(alpha: 0.3);
  static Color get orangeBorder => primaryOrange.withValues(alpha: 0.3);
  static Color get auroraBorder => rosyBrown.withValues(alpha: 0.4);

  // Ice-like borders with white highlights
  static Color get iceBorder => Colors.white.withValues(alpha: 0.3);
  static Color get iceHighlight => Colors.white.withValues(alpha: 0.15);
}
